...
public abstract class AbstractCommonJavaClass<C extends AbstractCommonJavaClass> implements CommonJavaClass<C> {
    ...
    public boolean equalsExact(Class<? extends CommonClass> class1){
    ...
    public List<InterfaceClass> getImplements() {
        ...
        for(Class<? extends Object> class1 : interfaces){
            list.add((InterfaceClass) AbstractCommonJavaClass.of(class1));
        }
        return list;
    }
    ...
    public List<CommonClass.Nested> getNestedClasses() {
        ...
        for(Class<? extends Object> class1 : classes){
            list.add((Nested) AbstractCommonJavaClass.of(class1));
        }
        return list;
    }
    ...
    public boolean isInstanceOf(CommonClass class1) {
        if(!(class1 instanceof AbstractCommonJavaClass)){
            return false;
        }
        AbstractCommonJavaClass cjc = (AbstractCommonJavaClass) class1;
    ...
    public static AbstractCommonJavaClass of(Class<? extends Object> class1){
