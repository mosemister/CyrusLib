...
public abstract class AbstractCommonCustomClass<C extends AbstractCommonCustomClass> implements CommonCustomClass<C> {
    ...
    public AbstractCommonCustomClass(String name, String... package1){
        this.name = name;
    ...
    @Override
    public AbstractCommonCustomClass setStatic(boolean tatic) {
        this.isStatic = tatic;
        return this;
    }

    @Override
    public AbstractCommonCustomClass setPackage(String... ackage) {
